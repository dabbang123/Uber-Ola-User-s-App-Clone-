...
class _MainScreenState extends State<MainScreen>
{
  ...
  //DatabaseReference? number = FirebaseDatabase.instance.ref().child("All Ride Requests");
  ...
  // getUser(){
  //   var the = FirebaseAuth.instance.currentUser!.phoneNumber; {
  //     _phone = phoneNumber.toString();
  //     setState(() {});
  //   };)
  // }
}
